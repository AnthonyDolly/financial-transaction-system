...
health: ## Health check de servicios
	...
	@echo
	@echo "🌐 HEALTH CHECKS:"
	@docker compose -f $(DOCKER_COMPOSE_PROD) --env-file $(ENV_PROD) exec -T app wget --no-verbose --tries=1 --spider http://localhost:3000/health > /dev/null 2>&1 && echo "✅ Aplicación: OK" || echo "❌ Aplicación: FAILED"
